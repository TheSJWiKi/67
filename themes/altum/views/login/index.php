    ...
    <?php if(settings()->facebook->is_enabled || settings()->google->is_enabled || settings()->twitter->is_enabled || settings()->discord->is_enabled): ?>
        ...
        <div class="">
            <?php if(settings()->facebook->is_enabled): ?>
                <div class="mt-2">
                    <a href="<?= url('login/facebook-initiate' . $data->redirect_append) ?>" class="btn btn-light btn-block">
            ...
            <?php if(settings()->google->is_enabled): ?>
                <div class="mt-2">
                    <a href="<?= url('login/google-initiate' . $data->redirect_append) ?>" class="btn btn-light btn-block">
            ...
            <?php if(settings()->twitter->is_enabled): ?>
                <div class="mt-2">
                    <a href="<?= url('login/twitter-initiate' . $data->redirect_append) ?>" class="btn btn-light btn-block">
            ...
            <?php if(settings()->discord->is_enabled): ?>
                <div class="mt-2">
                    <a href="<?= url('login/discord-initiate' . $data->redirect_append) ?>" class="btn btn-light btn-block">
