    ...
    <div class="card-body">
        ...
        <form name="update_vcard" action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div data-image-container="vcard_avatar" class="<?= !empty($data->link->settings->vcard_avatar) ? null : 'd-none' ?>">
                    <div class="row">
                    ...
                    <?php foreach($data->link->settings->vcard_phone_numbers ?? [] as $key => $phone_number): ?>
                        <div class="mb-4">
                            <div class="form-group">
                                ...
                                <input id="<?= 'vcard_phone_number_' . $key . '_' . $data->link->link_id ?>" type="text" name="vcard_phone_number[<?= $key ?>]" value="<?= $phone_number ?>" class="form-control" maxlength="<?= $data->link_types['vcard']['fields']['phone_number']['max_length'] ?>" required="required" />
                            </div>
