        ...
        <form action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div id="biolink_background_type_gradient">
                <div class="form-group">
                    ...
                    <input type="hidden" id="biolink_background_type_gradient_color_one" name="biolink_background_color_one" class="form-control form-control-lg" value="<?= $data->values['biolink_background_color_one'] ?? '#000000' ?>" data-color-picker />
                </div>

                <div class="form-group">
                    <label for="biolink_background_type_gradient_color_two"><?= l('link.settings.background_type_gradient_color_two') ?></label>
                    <input type="hidden" id="biolink_background_type_gradient_color_two" name="biolink_background_color_two" class="form-control form-control-lg" value="<?= $data->values['biolink_background_color_two'] ?? '#000000' ?>" data-color-picker />
                </div>
            </div>
            ...
            <div id="biolink_background_type_color">
                <div class="form-group">
                    ...
                    <input type="hidden" id="biolink_background_type_color" name="biolink_background" class="form-control form-control-lg" value="<?= is_string($data->values['biolink_background']) ? $data->values['biolink_background'] : '#000000' ?>" data-color-picker />
                </div>
            </div>
