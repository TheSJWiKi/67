                ...
                <section id="requirements" style="display: none">
                    ...
                    <table class="table mt-3">
                        ...
                        <tr>
                            ...
                            <td><?= PHP_VERSION ?></td>
                            <td>
                                <?php if(version_compare(PHP_VERSION, '7.4.0', '>=') && version_compare(PHP_VERSION, '8.2', '<')): ?>
                    ...
                    <table class="table mt-5">
                        ...
                        <tr>
                            <td>/uploads/main/</td>
                            <td><?= is_writable(ROOT . 'uploads/main/') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/main/')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                        ...
                        <tr>
                            <td>/uploads/blog/</td>
                            <td><?= is_writable(ROOT . 'uploads/blog/') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/blog/')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                ...
                <section id="setup" style="display: none">
                    ...
                    <form id="setup_form" method="post" action="" role="form">
                        <div class="form-group">
                            ...
                            <input placeholder="Enter any value!" type="text" class="form-control" id="license_key" name="license_key" required="required">
                        </div>
