                    ...
                    default:
                        ...
                        if($_POST['language_code'] != $language['code'] || $_POST['language_name'] != $language['name'] || $_POST['status'] != $language['status']) {
                            if(file_exists(Language::$path . $language['name'] . '#' . $language['code'] . '#' . $language['status'] . '.php')) {
                                rename(Language::$path . $language['name'] . '#' . $language['code'] . '#' . $language['status'] . '.php', Language::$path . $_POST['language_name'] . '#' . $_POST['language_code'] . '#' . $_POST['status'] . '.php');
                                rename(Language::$path . 'admin/' . $language['name'] . '#' . $language['code'] . '#' . $language['status'] . '.php', Language::$path . 'admin/' . $_POST['language_name'] . '#' . $_POST['language_code'] . '#' . $_POST['status'] . '.php');
                            }
                        }
                    break;
                }
