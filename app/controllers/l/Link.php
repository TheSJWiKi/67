            ...
            case 'paypal':
                ...
                $response = \Unirest\Request::post($paypal_api_url . 'v2/checkout/orders', $paypal_headers, \Unirest\Request\Body::json([
                    ...
                    'application_context' => [
                        ...
                        'user_action' => 'PAY_NOW',
                        'return_url' => $link->settings->thank_you_url ?: $link->full_url . '?payment_thank_you=' . $biolink_block->type . '&biolink_block_id=' . $biolink_block->biolink_block_id,
            ...
            case 'stripe':
                ...
                try {
                    $stripe_session = \Stripe\Checkout\Session::create([
                        ...
                        'success_url' => $link->settings->thank_you_url ?: $link->full_url . '?payment_thank_you=' . $biolink_block->type . '&biolink_block_id=' . $biolink_block->biolink_block_id,
                        'cancel_url' => $link->full_url . '?payment_cancelled=' . $biolink_block->type . '&biolink_block_id=' . $biolink_block->biolink_block_id,
                    ]);
                } catch (\Exception $exception) {
                    /* Delete inserted pending payment on error */
            ...
            case 'razorpay':
                ...
                try {
                    $response = $razorpay->paymentLink->create([
                        ...
                        'callback_url' => $link->settings->thank_you_url ?: $link->full_url . '?payment_thank_you=' . $biolink_block->type . '&biolink_block_id=' . $biolink_block->biolink_block_id,
                        'callback_method' => 'get'
                    ]);
                } catch (\Exception $exception) {
                    /* Delete inserted pending payment on error */
