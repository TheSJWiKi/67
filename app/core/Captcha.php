...
class Captcha {
    ...
    public function display() {
        ...
        if(settings()->captcha->type == 'recaptcha' && settings()->captcha->recaptcha_public_key && settings()->captcha->recaptcha_private_key) {
            echo '<div class="g-recaptcha d-flex justify-content-center" data-size="compact" data-sitekey="' . settings()->captcha->recaptcha_public_key . '"></div>';
            ...
            echo '<div class="h-captcha d-flex justify-content-center" data-size="compact" data-sitekey="' . settings()->captcha->hcaptcha_site_key . '"></div>';
            echo '<input type="hidden" name="captcha" class="form-control ' . (\Altum\Alerts::has_field_errors('captcha') ? 'is-invalid' : null) . '">';
            echo \Altum\Alerts::output_field_error('captcha');
            ...
            echo '<div class="cf-turnstile d-flex justify-content-center" data-size="compact" data-sitekey="' . settings()->captcha->turnstile_site_key . '"></div>';
            echo '<input type="hidden" name="captcha" class="form-control ' . (\Altum\Alerts::has_field_errors('captcha') ? 'is-invalid' : null) . '">';
            echo \Altum\Alerts::output_field_error('captcha');
